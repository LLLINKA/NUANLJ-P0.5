...
__isr_vector:
    ...
    .long   UARTOVF0_Handler            /* 16+ 2: UART 0 Overflow Handler    */
    .long   NFC_Handler                 /* 16+ 3: NFC Handler                */
    .long   NFC_POR_Handler             /* 16+ 4: NFC POWER Handler          */
    .long   IMEAS_Handler               /* 16+ 5: IMEAS Handler              */
    .long   ZMEAS_Handler               /* 16+ 6: ZMEAS Handler              */
    .long   EXT_WAKE_Handler            /* 16+ 7: EXT WAKE Handler           */
    .long   TIMER0_Handler              /* 16+ 8: TIMER 0 Handler            */
    .long   TIMER1_Handler              /* 16+ 9: TIMER 1 Handler            */
    .long   TIMER2_Handler              /* 16+10: TIMER 2 Handler            */
    .long   TIMER3_Handler              /* 16+11: TIMER 3 Handler            */
    .long   ZMEAS_ADC_Handler           /* 16+12: ZMEAS ADC Handler          */
    .long   PSW_WAKE_Handler            /* 16+13: PSW WAKE Handler           */
    .long   0                           /* 16+14: BOD15 Handler              */
    .long   0                           /* 16+15: BOD30 Handler              */
...
/* IRQ Handlers */
    ...
    def_default_handler    NFC_Handler
    def_default_handler    NFC_POR_Handler
    def_default_handler    IMEAS_Handler
    def_default_handler    ZMEAS_Handler
    def_default_handler    EXT_WAKE_Handler
    ...
    def_default_handler    ZMEAS_ADC_Handler
    def_default_handler    PSW_WAKE_Handler

...
typedef struct
{
  __IO uint32_t  WAVE_GEN_DRV_CONFIG_REG;          	/*!< Offset: 0x000 ADC Controller ADC Configuration Register (R/W) */
  __IO uint32_t  WAVE_GEN_DRV_CTRL_REG;       			/*!< Offset: 0x004 ADC Controller ADC Control Register (R/W) */
  __O  uint32_t  WAVE_GEN_DRV_REST_T_REG;       			/*!< Offset: 0x008 ADC Controller ADC Interrupt Enable Register (R/W) */
  __O  uint32_t  WAVE_GEN_DRV_SILENT_T_REG;   			/*!< Offset: 0x00C ADC Controller ADC Interrupt Status Register (R/) */
  __O  uint32_t  WAVE_GEN_DRV_HLF_WAVE_PRD_REG;   			/*!< Offset: 0x00C ADC Controller ADC Interrupt Clear Register (/W) */
  __O  uint32_t  WAVE_GEN_DRV_NEG_HLF_WAVE_PRD_REG;				/*!< Offset: 0x010 ADC Controller ADC Status Register (R) */ 
  __O  uint32_t  WAVE_GEN_DRV_CLK_FREQ_REG;				/*!< Offset: 0x014 ADC Controller ADC Clock Divider Register (R/W) */
  __O  uint32_t  WAVE_GEN_DRV_IN_WAVE_ADDR_REG;				/*!< Offset: 0x018 ADC Controller ADC Sampling Time register (R/W) */
  __O  uint32_t  WAVE_GEN_DRV_IN_WAVE_REG;				/*!< Offset: 0x01C ADC Controller ADC Data Register (R/W) */
  __O  uint32_t  WAVE_GEN_DRV_ALT_LIM_REG;				/*!< Offset: 0x020 ADC Controller ADC Channel Selection Register (R/W) */
  __O  uint32_t  WAVE_GEN_DRV_ALT_SILENT_LIM_REG;				/*!< Offset: 0x024 ADC Controller ADC EOC_Configuration_Register (R/W) */ 
